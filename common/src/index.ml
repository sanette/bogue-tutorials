...
(**
   ...
   code chunks by yourself. {e In fact, all tutorials have been designed so that
   ...
   you may append the option [--deps-only] if you don't want to install a local
   copy of the tutorials.
